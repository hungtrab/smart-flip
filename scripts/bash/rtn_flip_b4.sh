...
# Final full evaluation: naive RTN vs RTN + SmartFlip at 4-bit.
#
# Implementation note:
...
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-./data/cache/hf_datasets/datasets-rtn-flip-b4}"
LOG_DIR="${LOG_DIR:-./logs/rtn_flip_b4}"

WANDB_PROJECT="${WANDB_PROJECT:-rtn_flip_b4}"
