...
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-./data/cache/hf_datasets/datasets-rtn-flip-b3-ppl-first}"
LOG_DIR="${LOG_DIR:-./logs/rtn_flip_b3_ppl_first}"

WANDB_PROJECT="${WANDB_PROJECT:-rtn_flip_b3_ppl_first}"
